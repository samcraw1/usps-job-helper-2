...
export default function RootLayout({
  ...
  return (
    <html lang="en">
      <head>
        <meta name="google-adsense-account" content="ca-pub-7062135243367822" />
        <Script
          async
          src="https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js?client=ca-pub-7062135243367822"
